...
public class AdapterBgDialogSub extends RecyclerView.Adapter<AdapterBgDialogSub.ViewHolder> {

    private final Activity activity;
    private final BottomSheetDialog bgDialog;
    private final ArrayList<String> mediaPaths;

    public AdapterBgDialogSub(Activity activity, BottomSheetDialog bgDialog, ArrayList<String> mediaPaths) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bg_dialog_sub, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            subBgImg = itemView.findViewById(R.id.subBgImg);
        }
    }
}
