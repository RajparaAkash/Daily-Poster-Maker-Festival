...
public class AdapterEditColorBox extends RecyclerView.Adapter<AdapterEditColorBox.ColorViewHolder> {
    ...
    public AdapterEditColorBox(Activity activity, ColorAdapterListener colorAdapterListener) {
    ...
    public void onBindViewHolder(@NonNull ColorViewHolder holder, int position) {
        ...
        holder.colorSelectImg.setVisibility(MyUtil.edit_box_color_pos == position ? View.VISIBLE : View.GONE);
    ...
    public class ColorViewHolder extends RecyclerView.ViewHolder {
        ...
        public ColorViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                if (position != -1 && position < colorList.size()) {
                    // Notify the listener and update the selection
                    colorAdapterListener.onColorItemSelected(colorList.get(position));
                    MyUtil.edit_box_color_pos = position;
                    notifyDataSetChanged(); // Refresh the adapter to update selection UI
                }
            });
        }
    }
