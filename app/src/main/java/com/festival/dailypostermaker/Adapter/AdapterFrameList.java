...
public class AdapterFrameList extends DiscreteScrollView.Adapter<AdapterFrameList.ViewHolder> {

    private final Context context;
    private final ArrayList<PostDetails> postDetailsList;
    private final String tempURL;

    public AdapterFrameList(Context context, ArrayList<PostDetails> postDetailsList, String tempURL) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final AppCompatImageView imgSocialMedia;
