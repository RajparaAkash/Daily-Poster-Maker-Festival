...
public class AdapterEditColorText extends RecyclerView.Adapter<AdapterEditColorText.ColorViewHolder> {
    ...
    public AdapterEditColorText(Activity activity, ColorAdapterListener colorAdapterListener) {
    ...
    public void onBindViewHolder(@NonNull ColorViewHolder holder, int position) {
        ...
        holder.colorSelectImg.setVisibility(MyUtil.edit_color_pos == position ? View.VISIBLE : View.GONE);
    ...
    public class ColorViewHolder extends RecyclerView.ViewHolder {
        ...
        public ColorViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(view -> {
                if (getAdapterPosition() < colorList.size()) {
                    colorAdapterListener.onColorItemSelected(colorList.get(getAdapterPosition()));
                    MyUtil.edit_color_pos = getAdapterPosition();
